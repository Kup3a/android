...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle(R.string.sets);

        final EditText status=(EditText)view.findViewById(R.id.et_status);
        Button button = (Button)view.findViewById(R.id.bt_change_status);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.changeSmth(status.getText().toString());
            }
        });
